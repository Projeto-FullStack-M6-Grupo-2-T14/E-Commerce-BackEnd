...
import listAllPostersService from "../services/posters/listAllPosters.service.js";
import updatePosterService from "../services/posters/updatePoster.service.js";
import retrievePosterServices from "../services/posters/retrievePoster.service.js";
import deletePostersService from "../services/posters/deletePoster.service.js";
import createPosterServices from "../services/posters/createPoster.service.js";
import {
	TEntryPoster,
	TExitPoster,
	TListPosters,
...
const listAllPostersController = async (
	req: Request,
	res: Response
): Promise<Response> => {
...
const deletePostersController = async (
	req: Request,
	res: Response
): Promise<Response> => {
	const posterId: number = parseInt(req.params.id);
...
const updatePosterController = async (
	req: Request,
	res: Response
): Promise<Response> => {
	...
	const updatedPoster: TUpdatePosterResponse = await updatePosterService(
		newPosterData,
		posterId,
		userId
	);
