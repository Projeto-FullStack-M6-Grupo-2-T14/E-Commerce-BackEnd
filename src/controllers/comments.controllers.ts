...
import editCommentsService from "../services/comments/editComment.service"
...
const editCommentController = async (req: Request, res: Response): Promise<Response> => {
    const userId: number = parseInt(res.locals.userId)
...
export { createCommentController, listCommentController, editCommentController, deleteCommentController }